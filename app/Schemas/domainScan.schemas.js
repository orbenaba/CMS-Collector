...
DomainScanSchema.methods.addSystems = async function (systemsInput) {

    const systems = systemsInput.systems ? systemsInput.systems : systemsInput
    try {
        // console.log(`addSystems:${JSON.stringify(systems)}`);
